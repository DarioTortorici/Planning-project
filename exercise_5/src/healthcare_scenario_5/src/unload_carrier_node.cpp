...
class UnloadCarrier : public plansys2::ActionExecutorClient
{
public:
  double duration;
...
private:
  void do_work()
  {
    if (progress_ < 1.0)
    {
      ...
      send_feedback(progress_, "unload_carrier running");
    }
    else
    {
      finish(true, 1.0, "unload_carrier completed");
    ...
    std::cout << "Requesting for unloading the carrier... ["
...
int main(int argc, char **argv)
{
  ...
  auto node = std::make_shared<UnloadCarrier>();
