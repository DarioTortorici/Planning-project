(define (domain healthcare_scenario_2)
  ...
  (:types
    ...
    bot - object 
    box - object 
    carrier - object ;; Added carrier to contain boxes
    capacity - object ;; Added carrier capacity
    content - object 
    aspirine - content 
    scalpel - content
  ...
  (:predicates
    ...
    (bot_has_carrier ?bot - bot ?car - carrier) ;; Bot now has a carrier or not
    (bot_free ?bot - bot)
  ...
  (:action attach_carrier ;; modified load_box to attach a carrier onto a bot
