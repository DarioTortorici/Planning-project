(define (problem problem_1_scenario_2_numericFluents)
  (:domain healthcare_scenario_2_numericFluents)
  ...
  (:objects
    ...
    box1 box2 box3 - box
    car1 - carrier
    cap1 - capacity ;; Numeric capacity of car 1
    aspirine1 - aspirine
    scalpel1 - scalpel
  ...
  (:init
    ...
    (carrier_has_capacity car1 cap1)
    (= (carrier_load cap1 ) 0) ;; init carrier load to 0
    (= (carrier_capacity cap1) 2) ;; Carrier has a numeric capacity of 2
