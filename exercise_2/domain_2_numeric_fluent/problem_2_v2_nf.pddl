(define (problem problem_2_scenario_2_numericFluents)
  ...
  (:init
    ...
    (= (carrier_load cap1 ) 0) 
    (= (carrier_capacity cap1) 2) 

    ;; carrier 2
    (carrier_at car2 warehouse)
    (carrier_has_capacity car2 cap2)
    (= (carrier_load cap2 ) 0) 
    (= (carrier_capacity cap2) 4) ;; Carrier2 has a numeric capacity of 4
